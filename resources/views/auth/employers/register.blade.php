...
<body>
        ...
        <div class="position-absolute top-50 start-50 translate-middle">
            <div class="align-items-center reg-form d-flex flex-column justify-content-center">
                <h2>Welcome!</h2>
                <form action="{{route('register.employer')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="role" id="role" value="1" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        <input type="textarea" placeholder="Description" id="description" class="form-control" name="description"
                               required autofocus>
